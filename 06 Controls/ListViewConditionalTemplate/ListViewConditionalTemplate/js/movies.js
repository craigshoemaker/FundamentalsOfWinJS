(function () {
    var _movies = new WinJS.Binding.List([
        ...
        { title: "Oceans's Eleven", synopsis: "Danny Ocean and his eleven accomplices plan to rob three Las Vegas casinos simultaneously.", type: "Drama" },
    ...
    WinJS.Namespace.define("Application.Data", { "movies": _movies });
